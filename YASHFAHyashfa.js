  ...
  function Template(containerId, options = {}) {
    ...
    const DEFAULT_SETTINGS = {
      ...
      template2: {
        ...
        protectionMessageTitle: "Your order Lis now protected",
...
//             (p) => `
//             <div class="T1_inline-point" style="color: ${darkerTextColor}">
//               <div style="color: ${svgColor}">${svg(p.icon)}</div>
//               <span>${p.text}</span>
//             </div>`
//           )
//           .join("")}
...
//     function renderTemplate() {
//       const t = state.activeTemplate.toLowerCase();
//       if (t === "template" || t === "template1") return renderT1();
//       if (t === "template2") return renderT2();
//       if (t === "template3") return renderT3();
//       return renderT1(); // fallback to Template1
...
//           ${state.activeTemplate === "template2" ? bulletPointsHTML() : ""}
...
//       const points = Array.isArray(state.bulletPoints) && state.bulletPoints.length > 0 && 
//                      typeof state.bulletPoints[0] === 'object' ? 
//                      state.bulletPoints : 
//                      (state.bulletPoints || []).map(text => ({
//                        text: text,
...
//             (p) => `
//             <div class="T1_inline-point" style="color: ${darkerTextColor}">
//               <span class="T1_inline-point-icon" style="color: ${svgColor}">${svg(p.icon)}</span>
//               <span>${p.text}</span>
//             </div>`
//           )
//           .join("")}
...
//       if (t === "template2") return renderT2();
//       if (t === "template3") return renderT3();
//       return renderT1(); // default to template 1
//     }
...
//       // Update the template content based on the new template
//       const templateContent = DEFAULT_SETTINGS[template] || DEFAULT_SETTINGS.template;
//       Object.keys(templateContent).forEach(key => {
//         if (state[key] === undefined) {
//           state[key] = templateContent[key];
//         }
//       });
//       render();
//       bindEvents();
