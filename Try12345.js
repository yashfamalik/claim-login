  ...
  <div class="T1_inline-points">
    ${points
        ...
        <div class="T1_inline-point" style="color: ${darkerTextColor}">
          ${p.icon ? `
            <span class="T1_bullet-icon" style="color: ${svgColor}; display: inline-flex; align-items: center; margin-right: 8px;">
          ...
          ${showDetail ? `
            <div class="T1_protection-added">
              <div class="T1_icon-container-message">
                ${svg("check").replace(/stroke="currentColor"/g, `stroke="${state.colors.svgColor || state.colors.textColor || '#111111'}"`)}
              </div>
            ...
            <div class="T1_protection-message">
              <div class="T1_icon-container-message">
                ${svg("shield").replace(/stroke="currentColor"/g, `stroke="${state.colors.svgColor || state.colors.textColor || '#111111'}"`)}
              </div>
...
//           useGradient: true,
//           backgroundColor: theme.start,
//           gradientStart: getLighterColor ? getLighterColor(theme.start, 0.2) : "#8BE5B0",
//           gradientEnd: theme.end,
//           iconBackground: getLighterColor ? getLighterColor(theme.start, 0.1) : "#8BE5B0",
//           textColor: theme.start,
//           svgColor: theme.start,
//           toggleEnabled: getDarkerColor ? getDarkerColor(theme.start, 0.1) : "#5CC992",
//           toggleDisabled: "#e5e7eb",
//           buttonBg: getDarkerColor ? getDarkerColor(theme.start, 0.1) : "#5CC992",
//           buttonText: theme.start,
//           badgeBg: getDarkerColor ? getDarkerColor(theme.start, 0.1) : "#5CC992",
//           badgeText: theme.start,
//         };
//       })()
//     };
...
//     function bulletPointsHTML() {
//       const svgColor = state.colors.svgColor || (getLighterColor ? getLighterColor(state.colors.textColor, 0.3) : state.colors.textColor);
//       const darkerTextColor = getDarkerColor ? getDarkerColor(state.colors.textColor, 0.2) : state.colors.textColor;
...
//         <div class="T1_inline-point" style="color: ${darkerTextColor}">
//           ${p.icon ? `
//             <span style="color: ${svgColor}; fill: ${svgColor}; stroke: ${svgColor}; display: inline-flex;">
//               ${svg(p.icon).replace(/<svg/g, `<svg style="color: ${svgColor} !important; fill: ${svgColor} !important; stroke: ${svgColor} !important;"`)}
//             </span>
//           ` : ''}
//           <span>${p.text}</span>
//         </div>`
...
//       const backgroundColor = c.useGradient ? c.gradientStart : c.backgroundColor;
//       const textColor = c.textColor;
//       const darkerTextColor = getDarkerColor ? getDarkerColor(textColor, 0.2) : textColor;
//       const svgColor = c.svgColor || (getLighterColor ? getLighterColor(textColor, 0.3) : textColor);
...
// //       const points = state.bulletPoints.map(p => {
// //         if (typeof p === 'string') {
// //           // For string format, we don't have icons
// //           return { text: p, icon: null };
// //         }
// //         return p;
// //       });
...
// //             (p) => `
// //             <div class="T1_inline-point" style="color: ${darkerTextColor}">
// //               ${p.icon ? `<span style="color: ${svgColor}; fill: ${svgColor}; stroke: ${svgColor};">${svg(p.icon)}</span>` : ''}
// //               <span>${p.text}</span>
// //             </div>`
// //           )
// //           .join("")}
