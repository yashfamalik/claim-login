...
//   const backgroundColor = c.useGradient ? c.gradientStart : c.backgroundColor;
//   const textColor = c.textColor;
//   const darkerTextColor = getDarkerColor(textColor, 0.2); // Darken text color
//   const svgColor = c.svgColor || getLighterColor(textColor, 0.3); // Use SVG color or default to lighter text color
