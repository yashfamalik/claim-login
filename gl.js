...
<path d="M11.245 4.174C11.4765 3.50808 11.5922 3.17513 11.7634 3.08285C11.9115 3.00298 12.0898 3.00298 12.238 3.08285C12.4091 3.17513 12.5248 3.50808 12.7563 4.174L14.2866 8.57639C14.3525 8.76592 14.3854 8.86068 14.4448 8.93125C14.4972 8.99359 14.5641 9.04218 14.6396 9.07278C14.725 9.10743 14.8253 9.10947 15.0259 9.11356L19.6857 9.20852C20.3906 9.22288 20.743 9.23007 20.8837 9.36432C21.0054 9.48051 21.0605 9.65014 21.0303 9.81569C20.9955 10.007 20.7146 10.2199 20.1528 10.6459L16.4387 13.4616C16.2788 13.5829 16.1989 13.6435 16.1501 13.7217C16.107 13.7909 16.0815 13.8695 16.0757 13.9507C16.0692 14.0427 16.0982 14.1387 16.1563 14.3308L17.506 18.7919C17.7101 19.4667 17.8122 19.8041 17.728 19.9793C17.6551 20.131 17.5108 20.2358 17.344 20.2583C17.1513 20.2842 16.862 20.0829 16.2833 19.6802L12.4576 17.0181C12.2929 16.9035 12.2106 16.8462 12.1211 16.8239C12.042 16.8043 11.9593 16.8043 11.8803 16.8239C11.7908 16.8462 11.7084 16.9035 11.5437 17.0181L7.71805 19.6802C7.13937 20.0829 6.85003 20.2842 6.65733 20.2583C6.49056 20.2358 6.34626 20.131 6.27337 19.9793C6.18915 19.8041 6.29123 19.4667 6.49538 18.7919L7.84503 14.3308C7.90313 14.1387 7.93218 14.0427 7.92564 13.9507C7.91986 13.8695 7.89432 13.7909 7.85123 13.7217C7.80246 13.6435 7.72251 13.5829 7.56262 13.4616L3.84858 10.6459C3.28678 10.2199 3.00588 10.007 2.97101 9.81569C2.94082 9.65014 2.99594 9.48051 3.11767 9.36432C3.25831 9.23007 3.61074 9.22289 4.31559 9.20852L8.9754 9.11356C9.176 9.10947 9.27631 9.10743 9.36177 9.07278C9.43726 9.04218 9.50414 8.99359 9.55657 8.93125C9.61593 8.86068 9.64887 8.76592 9.71475 8.57639L11.245 4.174Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  function Template(containerId, options = {}) {
    ...
    const DEFAULT_SETTINGS = {
      ...
      iconStyle: {
        size: 32,
        color: "#72D9A3", // Green-Yellow theme start color
        background: "#a5ffd6", // getLighterColor("#72D9A3", 0.2) - exact match
        borderColor: "#E5E7EB",
        borderRadius: 9999,
        autoTheme: true,
      },
      ...
      enableProtectionControl: {
        enabled: true,
        backgroundColor: "#a5ffd6", // getLighterColor("#72D9A3", 0.2) - exact match
        textColor: "#72D9A3", // Green-Yellow theme start color
      ...
      colors: {
        // Green-Yellow theme from UNIFIED_THEMES[0] - exact values matching TemplateController
        useGradient: true,
    ...
    function iconHTML() {
      // Ensure customLogos is initialized
      ...
      // Check if this is a custom uploaded logo (either built-in with custom upload or completely custom)
      ...
      // Check if built-in logo has custom upload
      const logo = customLogos[logoKey];
      if (logo && logo.url) {
        return `
    ...
    function bulletPointsHTML() {
      const svgColor = state.colors.svgColor || state.colors.textColor || "#4A9B6B"; // getDarkerColor("#72D9A3", 0.3)
    ...
    /* Global SVG size control - applies to all SVGs unless overridden */
  ...
  `;
   ...
   <div class="T1_confirmation-message ${state.isEnabled ? "T1_visible" : ""}">${state.confirmationMessage}</div>
    ...
    function updateIconStyle(iconStyle = {}) {
      ...
      injectStyles(); // Re-inject styles to update icon size
      render();
      bindEvents();
    }
    ...
    function uploadCustomLogo(logoKey, file) {
      return new Promise((resolve, reject) => {
        ...
        // Initialize logo entry if it doesn't exist (for new custom uploads)
        if (!customLogos[logoKey]) {
...
//       activeTemplate: options.activeTemplate || DEFAULT_SETTINGS.activeTemplate,
//       isEnabled: options.isEnabled !== undefined ? options.isEnabled : DEFAULT_SETTINGS.isEnabled,
//       protectionPrice: options.protectionPrice !== undefined ? options.protectionPrice : DEFAULT_SETTINGS.protectionPrice,
//       selectionMode: options.selectionMode || DEFAULT_SETTINGS.selectionMode,
//       iconAsset: { ...DEFAULT_SETTINGS.iconAsset, ...options.iconAsset },
//       iconStyle: { ...DEFAULT_SETTINGS.iconStyle, ...options.iconStyle },
//       buttonBlock: { ...DEFAULT_SETTINGS.buttonBlock, ...options.buttonBlock },
...
//       activeTemplate: mergedOptions.activeTemplate,
//       isEnabled: mergedOptions.isEnabled,
//       protectionPrice: mergedOptions.protectionPrice,
//       onToggle: options.onToggle || (() => { }),
//       title: DEFAULT_SETTINGS[mergedOptions.activeTemplate]?.title || DEFAULT_SETTINGS.template.title,
//       description: DEFAULT_SETTINGS[mergedOptions.activeTemplate]?.description || DEFAULT_SETTINGS.template.description,
//       confirmationMessage: DEFAULT_SETTINGS[mergedOptions.activeTemplate]?.confirmationMessage || "Your order is now protected!",
//       badgeText: DEFAULT_SETTINGS[mergedOptions.activeTemplate]?.badgeText || "Protected",
//       bulletPoint1: DEFAULT_SETTINGS[mergedOptions.activeTemplate]?.bulletPoint1 || "Secure Coverage",
//       bulletPoint2: DEFAULT_SETTINGS[mergedOptions.activeTemplate]?.bulletPoint2 || "Instant Claims",
//       bulletPoint3: DEFAULT_SETTINGS[mergedOptions.activeTemplate]?.bulletPoint3 || "Trusted by 50k+",
//       bulletPoints: (() => {
//         const bulletPoints = options.bulletPoints || [
//           { text: DEFAULT_SETTINGS[mergedOptions.activeTemplate]?.bulletPoint1 || "Secure Coverage", icon: "shield" },
//           { text: DEFAULT_SETTINGS[mergedOptions.activeTemplate]?.bulletPoint2 || "Instant Claims", icon: "lightning" },
//           { text: DEFAULT_SETTINGS[mergedOptions.activeTemplate]?.bulletPoint3 || "Trusted by 50k+", icon: "star" }
//         ];
//         return bulletPoints;
//       })(),
//       protectionAddedText: DEFAULT_SETTINGS[mergedOptions.activeTemplate]?.protectionAddedText || "Protection Added",
//       protectionMessage: {
//         title: DEFAULT_SETTINGS[mergedOptions.activeTemplate]?.protectionMessageTitle || "Your order is now protected",
//         subtext: DEFAULT_SETTINGS[mergedOptions.activeTemplate]?.protectionMessageSubtext || "If your package is lost, stolen, or damaged, we'll replace it or provide a full refund — no questions asked."
//       },
//       additionalParagraphs: options.additionalParagraphs || [],
//       colors: mergedOptions.colors,
//       selectionMode: mergedOptions.selectionMode,
...
//       const logoKey = state.iconAsset.name || "logo1";
//       const logo = customLogos[logoKey];
//       const svgColor = state.colors.svgColor || fallbackGetLighterColor(state.colors.textColor, 0.3);
//       if (state.iconAsset.url) {
//         return `
//           <div class="T1_icon-custom">
//             <img src="${state.iconAsset.url}" style="width:100%;height:100%;object-fit:contain" alt="Custom icon"/>
...
//     function checkboxHTML() {
//       const darkerTextColor = fallbackGetDarkerColor(state.colors.textColor);
//       return `
//         <input type="checkbox" class="T1_checkbox" id="T1_protection_checkbox_${self.instanceId}" ${state.isEnabled ? "checked" : ""}/>
//         <label for="T1_protection_checkbox_${self.instanceId}" style="cursor:pointer;margin-left:4px;font-size:12px;color:${darkerTextColor};"></label>
//       `;
//     }
...
//       return `
//         <div class="T1_toggle">
//           <input type="checkbox" class="T1_toggle-checkbox" id="T1_toggle_checkbox_${self.instanceId}" ${state.isEnabled ? "checked" : ""}>
//           <div class="toggle-track">
//             <div class="toggle-handle"></div>
//           </div>
//         </div>
...
//       s.id = id;
//       const c = state.colors;
//       const darkerTextColor = fallbackGetDarkerColor(c.textColor, 0.2);
//       const svgColor = c.svgColor || fallbackGetLighterColor(c.textColor, 0.3);
//       s.textContent = `
//         .T1_shipping-protection {
//           background: ${c.useGradient ? `linear-gradient(135deg, ${c.gradientStart}, ${c.gradientEnd})` : c.backgroundColor};
//           border-radius: 8px;
...
//               ${state.selectionMode === "toggle" ? toggleHTML() : ""}
//               ${state.selectionMode === "checkbox" ? checkboxHTML() : ""}
//               ${state.selectionMode === "button" ? `<a href="${state.buttonBlock.buttonHref}" class="T1_protection-button">${state.buttonBlock.buttonLabel}</a>` : ""}
//             </div>
//           </div>
//           ${bulletPointsHTML()}
//           ${showDetail ? `
//             <div class="T1_protection-added">
//               <div class="T1_icon-container-message">
//                 ${svg("check").replace(/stroke="currentColor"/g, `stroke="${state.colors.svgColor || state.colors.textColor || '#4A9B6B'}"`)}
//               </div>
//               <span>${state.protectionAddedText}</span>
//               <br />
//               <span> (+$${state.protectionPrice.toFixed(2)})</span>
...
//             <div class="T1_protection-message">
//               <div class="T1_icon-container-message">
//                 ${svg("shield").replace(/stroke="currentColor"/g, `stroke="${state.colors.svgColor || state.colors.textColor || '#4A9B6B'}"`)}
//               </div>
//               <div class="T1_protection-message-content">
//                 <p class="T1_protection-message-title">${state.protectionMessage.title}</p>
//                 <p class="T1_protection-message-subtext">${state.protectionMessage.subtext}</p>
...
//         if (k in state) state[k] = settings[k];
//       });
//       render();
//       bindEvents();
//     }
...
//     const template = Template("Template1-container", {
//       activeTemplate: "Template1", // Change to "Template2" or "Template3" to switch
//       isEnabled: true,
//       protectionPrice: 5.99,
//       onToggle: function(enabled) {
//         console.log("Protection is now " + (enabled ? "enabled" : "disabled"));
