...
//          style="${toggleStyle}">
//       <span class="T1_toggle-handle" style="background: #fff;"></span>
//     </div>
//   `;
// }
...
//   const ls = state.logoSettings;
//   const toggleEnabledColor = state.colors.toggleEnabled;
//   const toggleDisabledColor = state.colors.toggleDisabled;
...
//       border-radius: 9999px;
//       cursor: pointer;
//       transition: ${state.enableProtectionControl.transition};
//       font-size: ${state.enableProtectionControl.fontSize}px;
...
//       .T1_toggle{position:relative;accent-color:${c.toggleEnabled};display:inline-flex;height:24px;min-width:44px;align-items:center;border-radius:9999px;cursor:pointer;transition:${state.enableProtectionControl.transition};font-size:${state.enableProtectionControl.fontSize}px}
...
//       .T1_toggle.T1_enabled.T1_toggle-handle{transform:translateX(10px);accent-color:${c.toggleEnabled}}
...
//       .T1_icon-custom:hover{transform:scale(1.1)}
...
//           </div>`;
//             } else {
//                 // Use actual SVG with enhanced styling and theme colors
//                 let svgContent = CUSTOM_LOGO_MAP[logoKey] || CUSTOM_LOGO_MAP["logo1"];

//                 // Apply theme colors to the SVG based on settings
//                 if (state.iconStyle.autoTheme) {
//                     // Auto-theme with text color
//                     svgContent = svgContent.replace(/#3AAF3C/g, state.colors.textColor);
//                 } else {
//                     // Use custom SVG colors - replace default green with custom color
//                     svgContent = svgContent.replace(/#3AAF3C/g, state.iconStyle.color);
//                 }
...
//       .T1_logo-container{max-width:${ls.maxWidth}px;max-height:${ls.maxHeight}px;overflow:hidden;margin-right:8px}
//       .T1_logo-container img{max-width:100%;max-height:100%;object-fit:contain}
//       .T1_icon-custom{width:${is.size}px;height:${is.size}px;
//       display:flex;
//       align-items:center;
//       justify-content:center;
//       .T1_icon-uploaded{background:linear-gradient(135deg, ${is.background}, ${getLighterColor(is.background)});box-shadow:0 2px 8px rgba(0,0,0,0.1)}
...
//             // Re-render to apply new colors to SVGs
//             render();
//             bindEvents();
//         }
