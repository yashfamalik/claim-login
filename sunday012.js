  ...
  function Template(containerId, options = {}) {
    ...
    const DEFAULT_SETTINGS = {
      ...
      colors: {
        ...
        useGradient: true,
        backgroundColor: "#72D9A3", // Green-Yellow theme start
        gradientStart: "#a5ffd6", // getLighterColor("#72D9A3", 0.2)
        gradientEnd: "#F3EEA5", // Green-Yellow theme end
        iconBackground: "#a5ffd6", // getLighterColor("#72D9A3", 0.2)
        textColor: "#72D9A3", // Green-Yellow theme start
        svgColor: "#258c56", // getDarkerColor("#72D9A3", 0.3)
        toggleEnabled: "#a5ffd6", // getLighterColor("#72D9A3", 0.2)
        toggleDisabled: "#e5e7eb",
        buttonBg: "#58bf89", // getDarkerColor("#72D9A3", 0.1)
        buttonText: "#72D9A3", // Green-Yellow theme start
        badgeBg: "#58bf89", // getDarkerColor("#72D9A3", 0.1)
        badgeText: "#72D9A3", // Green-Yellow theme start
      },
    };
...
//         size: 32,
//         color: "#72D9A3", // Green-Yellow theme start color
//         background: "#8DE1B3", // getLighterColor("#72D9A3", 0.1)
//         borderColor: "#E5E7EB",
//         borderRadius: 9999,
//         autoTheme: true,
//       },
...
//       enableProtectionControl: {
//         enabled: true,
//         backgroundColor: "#8DE1B3", // getLighterColor("#72D9A3", 0.1) - Green-Yellow theme
//         textColor: "#72D9A3", // Green-Yellow theme start color
//         disabledBackgroundColor: "#d1d5db",
//         disabledTextColor: "#6b7280",
//         enabledText: "Protection Enabled",
...
//       },
//       colors: (() => {
//         // Green-Yellow theme from UNIFIED_THEMES[0] - matching TemplateController exactly
//         const theme = { name: "Green-Yellow", start: "#72D9A3", end: "#F3EEA5" };
//         const darkerColorFn = getDarkerColor || fallbackGetDarkerColor;
//         const lighterColorFn = getLighterColor || fallbackGetLighterColor;
//         return {
//           useGradient: true,
...
//           iconBackground: lighterColorFn(theme.start, 0.2),
//           textColor: theme.start,
//           svgColor: darkerColorFn(theme.start, 0.3),
//           toggleEnabled: lighterColorFn(theme.start, 0.2),
//           toggleDisabled: "#e5e7eb",
...
// // // //       },
// // // //       colors: (() => {
// // // //         // Green-Yellow theme from UNIFIED_THEMES[0]
