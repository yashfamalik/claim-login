    ...
    function Template1(containerId, options = {}) {
        ...
        const DEFAULT_SETTINGS = {
            ...
            template2: {
                ...
                inlinePoint3: "Instant Claims",
                inlinePoint4: "Trusted by 50k+",
        ...
        let state = {
            ...
            inlinePoints: options.inlinePoints || [
                ...
                { text: contentOptions.inlinePoint3 || "Instant Claims", icon: "lightning" },
                { text: contentOptions.inlinePoint4 || "Trusted by 50k+", icon: "star" }
            ],
