          ...
          <div class="T1_icon-custom T1_icon-uploaded" data-logo-category="${logo.category || 'default'}">
            ...
            <div class="T1_icon-overlay" style="opacity:0"></div>
                ...
                if (state.iconStyle.autoTheme) {
                    ...
                    svgContent = applyThemeToSvg(svgContent, { textColor: state.colors.textColor });
                } else {
                    // Use custom SVG colors
                    svgContent = applyThemeToSvg(svgContent, { textColor: state.iconStyle.color });
                }
