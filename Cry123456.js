(function (global) {
  "use strict";
  const { getDarkerColor, getLighterColor } = global.colorUtils || {};
  ...
  const fallbackGetLighterColor = (hex, amount = 0.2) => {
...
<path d="M7 10.0288C7.47142 10 8.05259 10 8.8 10H15.2C15.9474 10 16.5286 10 17 10.0288M7 10.0288C6.41168 10.0647 5.99429 10.1455 5.63803 10.327C5.07354 10.6146 4.6146 11.0735 4.32698 11.638C4 12.2798 4 13.1198 4 14.8V16.2C4 17.8802 4 18.7202 4.32698 19.362C4.6146 19.9265 5.07354 20.3854 5.63803 20.673C6.27976 21 7.11984 21 8.8 21H15.2C16.8802 21 17.7202 21 18.362 20.673C18.9265 20.3854 19.3854 19.9265 19.673 19.362C20 18.7202 20 17.8802 20 16.2V14.8C20 13.1198 20 12.2798 19.673 11.638C19.3854 11.0735 18.9265 10.6146 18.362 10.327C18.0057 10.1455 17.5883 10.0647 17 10.0288M7 10.0288V8C7 5.23858 9.23858 3 12 3C14.7614 3 17 5.23858 17 8V10.0288" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    users: `<svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M16 3.13C16.8604 3.35031 17.623 3.85071 18.1676 4.55232C18.7122 5.25392 19.0078 6.11683 19.0078 7.005C19.0078 7.89317 18.7122 8.75608 18.1676 9.45768C17.623 10.1593 16.8604 10.6597 16 10.88" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    lightning: `<svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M11.245 4.174C11.4765 3.50808 11.5922 3.17513 11.7634 3.08285C11.9115 3.00298 12.0898 3.00298 12.238 3.08285C12.4091 3.17513 12.5248 3.50808 12.7563 4.174L14.2866 8.57639C14.3525 8.76592 14.3854 8.86068 14.4448 8.93125C14.4972 8.99359 14.5641 9.04218 14.6396 9.07278C14.725 9.10743 14.8253 9.10947 15.0259 9.11356L19.6857 9.20852C20.3906 9.22288 20.743 9.23007 20.8837 9.36432C21.0054 9.48051 21.0605 9.65014 21.0303 9.81569C20.9955 10.007 20.7146 10.2199 20.1528 10.6459L16.4387 13.4616C16.2788 13.5829 16.1989 13.6435 16.1501 13.7217C16.107 13.7909 16.0815 13.8695 16.0757 13.9507C16.0692 14.0427 16.0982 14.1387 16.1563 14.3308L17.506 18.7919C17.7101 19.4667 17.8122 19.8041 17.728 19.9793C17.6551 20.131 17.5108 20.2358 17.344 20.2583C17.1513 20.2842 16.862 20.0829 16.2833 19.6802L12.4576 17.0181C12.2929 16.9035 12.2106 16.8462 12.1211 16.8239C12.042 16.8043 11.9593 16.8043 11.8803 16.8239C11.7908 16.8462 11.7084 16.9035 11.5437 17.0181L7.71805 19.6802C7.13937 20.0829 6.85003 20.2842 6.65733 20.2583C6.49056 20.2358 6.34626 20.131 6.27337 19.9793C6.18915 19.8041 6.29123 19.4667 6.49538 18.7919L7.84503 14.3308C7.90313 14.1387 7.93218 14.0427 7.92564 13.9507C7.91986 13.8695 7.89432 13.7909 7.85123 13.7217C7.80246 13.6435 7.72251 13.5829 7.56262 13.4616L3.84858 10.6459C3.28678 10.2199 3.00588 10.007 2.97101 9.81569C2.94082 9.65014 2.99594 9.48051 3.11767 9.36432C3.25831 9.23007 3.61074 9.22289 4.31559 9.20852L8.9754 9.11356C9.176 9.10947 9.27631 9.10743 9.36177 9.07278C9.43726 9.04218 9.50414 8.99359 9.55657 8.93125C9.61593 8.86068 9.64887 8.76592 9.71475 8.57639L11.245 4.174Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    check: `<svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  function Template(containerId, options = {}) {
    ...
    const DEFAULT_SETTINGS = {
      ...
      template: {
        ...
        description: i18n.t("Template.description"),
        isEnabled: true,
      },
      template2: {
         title: i18n.t("Template.title"),
    description: i18n.t("Template.description"),
    bulletPoint1: i18n.t("Template.bulletPoint1"),
    bulletPoint2: i18n.t("Template.bulletPoint2"),
    bulletPoint3: i18n.t("Template.bulletPoint3"),
    protectionAddedText: i18n.t("Template.protectionAddedText"),
    protectionMessageTitle: i18n.t("Template.protectionMessage.title"),
    protectionMessageSubtext: i18n.t("Template.protectionMessage.subtext"),
    isEnabled: true,
      },
      template3: {
        title: i18n.t("Template.title"),
        description: i18n.t("Template.description"),
        confirmationMessage: i18n.t("Template.confirmationMessage"),
        badgeText: i18n.t("Template.badgeText"),
        isEnabled: true,
      },
      ...
      buttonBlock: {
        buttonLabel: i18n.t("Template.buttonBlock.buttonLabel"),
        buttonHref: "https://example.com/cta",
        paragraph: i18n.t("Template.buttonBlock.paragraph")
      },
      enableProtectionControl: {
        ...
        enabledText: i18n.t("Template.enableProtectionControl.enabledText"),
        disabledText: i18n.t("Template.enableProtectionControl.disabledText"),
        showText: false,
        borderRadius: 24,
        borderWidth: 0,
      ...
      colors: (() => {
        const theme = { start: "#7fe7b0", end: "#e9e38b" };
        ...
        return {
          ...
          gradientStart: lighterColorFn(theme.start, 0.2),
          gradientEnd: theme.end,
          iconBackground: lighterColorFn(theme.start, 0.1),
          textColor: theme.start,
          svgColor: darkerColorFn(theme.start, 0.3),
          toggleEnabled: darkerColorFn(theme.start, 0.1),
          toggleDisabled: "#e5e7eb",
          buttonBg: darkerColorFn(theme.start, 0.1),
          buttonText: theme.start,
          badgeBg: darkerColorFn(theme.start, 0.1),
          badgeText: theme.start,
        };
      })()
    };
    const mergedOptions = {
    ...
    let state = {
      ...
      confirmationMessage: contentOptions.confirmationMessage || i18n.t("Template.confirmationMessage"),
      badgeText: contentOptions.badgeText || i18n.t("Template.badgeText"),
      bulletPoint1: contentOptions.bulletPoint1 || i18n.t("Template.bulletPoint1"),
      bulletPoint2: contentOptions.bulletPoint2 || i18n.t("Template.bulletPoint2"),
      bulletPoint3: contentOptions.bulletPoint3 || i18n.t("Template.bulletPoint3"),
      bulletPoints: (() => {
        const bulletPoints = options.bulletPoints || [
          { text: contentOptions.bulletPoint1 || i18n.t("Template.bulletPoint1"), icon: "shield" },
          { text: contentOptions.bulletPoint2 || i18n.t("Template.bulletPoint2"), icon: "lightning" },
          { text: contentOptions.bulletPoint3 || i18n.t("Template.bulletPoint3"), icon: "star" }
        ];
        return bulletPoints;
      })(),
      protectionAddedText: contentOptions.protectionAddedText || i18n.t("Template.protectionAddedText"),
      protectionMessage: {
        title: contentOptions.protectionMessageTitle || i18n.t("Template.protectionMessage.title"),
        subtext: contentOptions.protectionMessageSubtext || i18n.t("Template.protectionMessage.subtext")
      },
  ...
  return svgContent;
   ...
   const svgColor = state.colors.svgColor || state.colors.textColor || "#111111";
  const points = state.bulletPoints.map(p => ({
   ...
   if (points.length === 0 || points.filter(p => p.icon).length === 0) {
        points.push(
          { text: i18n.t("Template.bulletPoint1"), icon: "shield" },
          { text: i18n.t("Template.bulletPoint2"), icon: "lightning" },
          { text: i18n.t("Template.bulletPoint3"), icon: "star" }
        );
      }
       const html = `
          ...
          ${showDetail ? `
            <div class="T1_protection-added">
              <div class="T1_icon-container-message">
                ${svg("check")
            .replace(/stroke="currentColor"/g, `stroke="${state.colors.svgColor || state.colors.textColor || '#111111'}"`)
   ...
   <div class="T1_confirmation-message ${state.isEnabled ? "T1_visible" : ""}">${state.confirmationMessage}</div>
    ...
    function updateContentSettings(settings = {}) {
      ...
      if (settings.bulletPoint1 !== undefined || settings.bulletPoint2 !== undefined || settings.bulletPoint3 !== undefined) {
        state.bulletPoints = [
          { text: settings.bulletPoint1 || state.bulletPoint1 || i18n.t("Template.bulletPoint1"), icon: "shield" },
          { text: settings.bulletPoint2 || state.bulletPoint2 || i18n.t("Template.bulletPoint2"), icon: "lightning" },
          { text: settings.bulletPoint3 || state.bulletPoint3 || i18n.t("Template.bulletPoint3"), icon: "star" }
        ];
      }
...
//   // Fallback color utility functions if global.colorUtils is not available
//   const fallbackGetDarkerColor = (hex, amount = 0.2) => {
//     if (!hex || typeof hex !== "string") return "#333333"; // Safe fallback
//     try {
//       let color = hex.replace("#", "");
//       if (color.length === 3) {
//         color = color.split("").map(char => char + char).join("");
...
//   };
//   const fallbackGetLighterColor = (hex, amount = 0.2) => {
//     if (!hex || typeof hex !== "string") return "#cccccc"; // Safe fallback
//     try {
//       let color = hex.replace("#", "");
//       if (color.length === 3) {
//         color = color.split("").map(char => char + char).join("");
...
//     // Generate unique instance ID to prevent duplicate IDs
//     self.instanceId = `${containerId}_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`;
//     const container = document.getElementById(containerId);
//     if (!container) {
...
//       },
//       colors: (() => {
//         // Match the generateThemeColors function from controller
//         const theme = { start: "#72D9A3", end: "#F3EEA5" }; // Green-Yellow theme
//         const darkerColorFn = getDarkerColor || fallbackGetDarkerColor;
//         const lighterColorFn = getLighterColor || fallbackGetLighterColor;
//         return {
//           useGradient: true,
...
//       // Individual bullet point fields
...
//         ];
//         // console.log("Template.js - Constructor bulletPoints:", {
//         //   optionsBulletPoints: options.bulletPoints,
//         //   finalBulletPoints: bulletPoints,
//         //   contentOptions
//         // });
//         return bulletPoints;
//       })(),
...
//       } else {
//         const svgContent = CUSTOM_LOGO_MAP[logoKey] || CUSTOM_LOGO_MAP["logo1"];
//         // Apply the svgColor to the SVG content
//         const svgColor = state.colors.svgColor || getLighterColor(state.colors.textColor, 0.3);
//         const coloredSvgContent = svgContent.replace(/<svg/g, `<svg style="color: ${svgColor} !important; fill: ${svgColor} !important;"`);
//         return `
//           <div class="T1_icon-custom" data-logo-category="${logo.category || 'default'}">
...
//   const svgContent = SVG[name] || SVG.shield;
//   if (!svgContent) {
//     // console.warn(`SVG not found for: ${name}`);
//     return SVG.shield;
//   }
//   return svgContent;
// }
...
//     icon: p.icon || null
//   }));
//       // Debug: Detailed bullet points info
//       // console.log("Template.js - Bullet points detailed:", {
//       //   originalBulletPoints: state.bulletPoints,
//       //   processedPoints: points,
//       //   count: points.length,
//       //   withIcons: points.filter(p => p.icon).length,
//       //   activeTemplate: state.activeTemplate
//       // });
//       // Force test bullet points if none exist
//       if (points.length === 0 || points.filter(p => p.icon).length === 0) {
//         // console.log("Template.js - No bullet points with icons found, using test data");
//         points.push(
...
//       if (t === "Template2") return renderT2();
//       if (t === "Template3") return renderT3();
//       return renderT1(); // fallback to Template1
//     }
//     function renderT1() {
//       state.container.innerHTML = `
//         <div class="T1_shipping-protection">
...
//     }
//     function updateContentSettings(settings = {}) {
//       // console.log("Template.js - updateContentSettings called with:", settings);
//       const keys = [
//         "title",
//         "description",
//         "protectionPrice",
...
//       keys.forEach((k) => {
//         if (settings[k] !== undefined) {
//           // console.log(`Template.js - Updating ${k}:`, settings[k]);
//           state[k] = settings[k];
//         }
//       });
//       // Handle individual bullet point fields and convert to bulletPoints array
//       if (settings.bulletPoint1 !== undefined || settings.bulletPoint2 !== undefined || settings.bulletPoint3 !== undefined) {
//         state.bulletPoints = [
...
//         ];
//         // console.log("Template.js - Updated bulletPoints array:", state.bulletPoints);
//       }
//       if (settings.protectionMessageTitle !== undefined)
//         state.protectionMessage.title = settings.protectionMessageTitle;
//       if (settings.protectionMessageSubtext !== undefined)
...
//           }
//         });
//         // console.info("Active Template instance set for proxy access.");
//       }
//     };
//     function warnNoInstance(fn, argName) {
//       // console.warn("No Template instance found. Please create an instance first or use an existing instance.");
//       // console.info(`Example:
//       // const template = Template("your-container-id");
//       // template.${fn}(${argName});`);
//     }
//   }
// })(typeof window !== "" ? window : globalThis);
...
// //       return `
// //                 <div class="T1_toggle">
// //                 <input type="checkbox" class="T1_toggle-checkbox" id="T1_toggle_checkbox" name="T1_toggle" aria-label="Enable protection" ${state.isEnabled ? "checked" : ""}>
// //                 <div class="toggle-track">
// //                     <div class="toggle-handle"></div>
// //                 </div>
// //                 </div>
...
// // // //         return SVG.shield;
// // // //       }
// // // //       // Debug: Log SVG requests (only for bullet icons)
// // // //       if (["shield", "lightning", "star"].includes(name)) {
// // // //         console.log(`Template.js - svg(${name}) called for bullet point`);
// // // //       }
// // // //       return svgContent;
// // // //     }
...
// // // //       // Debug: Essential color info
// // // //       console.log("Template.js - Colors:", { svgColor, fallbackUsed: !getDarkerColor });

// // // //       // Handle both object format {text, icon} and string format
// // // //       const points = state.bulletPoints.map(p => {
// // // //         if (typeof p === 'string') {
// // // //           return { text: p, icon: null };
// // // //         }
// // // //         return p;
// // // //       });
      
// // // //       // Debug: Bullet points info
// // // //       console.log("Template.js - Bullet points:", { 
// // // //         count: points.length, 
// // // //         withIcons: points.filter(p => p.icon).length 
// // // //       });
...
// // // //                 .replace(/width="20px"/g, `width="18px"`)
// // // //                 .replace(/height="20px"/g, `height="18px"`)
