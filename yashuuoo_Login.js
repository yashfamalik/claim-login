...
//       .clm-container {
//         width: 100%; max-width: 370px; background: var(--clm-card-bg);
//         padding: 1em; box-sizing: border-box; border-radius: 12px;
//         border: 1px solid #ebebeb; box-shadow: 0 1px 2px rgba(0,0,0,0.05);
//       }
//       .clm-container.gradient {
//         background: linear-gradient(90deg, var(--clm-gradient-start), var(--clm-gradient-end));
...
//       .clm-form { display: flex; flex-direction: column; gap: 0.5rem; }
//       .clm-heading {
//         font-size: 1.25rem; font-weight: 600; color: var(--clm-heading-text);
//         text-align: left; margin: 0; word-wrap: break-word; letter-spacing: -0.025em;
//       }
//       .clm-fields { display: flex; flex-direction: column; gap: 0.5rem; }
//       .clm-label { display: block; color: var(--clm-label-text); font-weight: 500; font-size: 0.875rem; }
//       .clm-input {
//         width: 100%; padding: 0.5rem 0.75rem; border: 1px solid #e1e5e9;
//         border-radius: 0.375rem; background: #fff; color: #333; font-size: 1rem;
//         box-sizing: border-box; transition: all 0.2s ease; font-family: inherit;
//       }
//       .clm-input::placeholder { color: #9ca3af; }
//       .clm-input:focus {
...
//       }
//       .clm-error {
//         display: none; border-radius: 8px; padding: 0.5rem; background: #fef2f2;
//         color: #dc2626; border: 1px solid #fecaca; font-size: 0.875rem;
//         align-items: center; gap: 0;
//       }
//       .clm-error.show { display: flex; }
//       .clm-error .clm-error-icon { display: flex; align-items: center; margin-right: 0.5rem; }
//       .clm-button {
//         width: 100%; padding: 0.5rem 0.75rem; border: none; border-radius: 0.375rem;
//         background: var(--clm-button-bg); color: var(--clm-button-text); cursor: pointer;
//         font-weight: 500; font-size: 1rem; transition: all 0.2s ease; font-family: inherit;
//       }
//       .clm-button:active {
...
//       errorText: q(".clm-error .clm-error-text"),
//     };
//     if (settings.heading && el.heading) el.heading.textContent = settings.heading;
//     if (settings.emailLabel && el.emailLabel) el.emailLabel.textContent = settings.emailLabel;
//     if (settings.orderNumberLabel && el.orderLabel) el.orderLabel.textContent = settings.orderNumberLabel;
//     if (settings.emailPlaceholder && el.emailInput) el.emailInput.placeholder = settings.emailPlaceholder;
//     if (settings.orderNumberPlaceholder && el.orderInput) el.orderInput.placeholder = settings.orderNumberPlaceholder;
//     if (settings.buttonText && el.button) el.button.textContent = settings.buttonText;
//     if (settings.errorMessage && el.errorText) el.errorText.textContent = settings.errorMessage;
//   },
...
//     svg.setAttribute("viewBox", "0 0 20 20");
//     svg.setAttribute("class", "Icon_Icon__uZZKy");
//     svg.setAttribute("style", "width: 20px; height: 20px; fill: #dc2626; color: #dc2626;");
//     [
...
//   buildForm(onSubmit) {
//     const d = this.config.defaults;
//     const wrapper = this.createElement("div", { className: "clm-wrapper", id: this.config.containerId });
//     const container = this.createElement("div", { className: "clm-container", attrs: { novalidate: true } });
//     const form = this.createElement("form", { className: "clm-form", attrs: { novalidate: true } });
//     const heading = this.createElement("h1", { className: "clm-heading", text: d.heading });
//     const fields = this.createElement("div", { className: "clm-fields" });

//     const emailLabel = this.createElement("label", { className: "clm-label", text: d.emailLabel, attrs: { for: "email" } });
//     const emailInput = this.createElement("input", {
//       className: "clm-input",
//       attrs: { type: "email", name: "email", id: "email", placeholder: d.emailPlaceholder, autocomplete: "email", required: true }
//     });
//     const orderLabel = this.createElement("label", { className: "clm-label", text: d.orderLabel, attrs: { for: "order" } });
//     const orderInput = this.createElement("input", {
//       className: "clm-input",
//       attrs: { type: "text", name: "order", id: "order", placeholder: d.orderPlaceholder, autocomplete: "off", required: true }
//     });

//     const errorDiv = this.createElement("div", { className: "clm-error" });
//     const iconContainer = this.createElement("span", { className: "clm-error-icon" });
//     iconContainer.appendChild(this.createErrorIcon());
//     const errorText = this.createElement("span", { className: "clm-error-text", text: d.errorMessage });
//     errorDiv.append(iconContainer, errorText);

//     const submitButton = this.createElement("button", { className: "clm-button", text: d.buttonText, attrs: { type: "submit" } });

//     fields.append(emailLabel, emailInput, orderLabel, orderInput);
//     form.append(heading, fields, errorDiv, submitButton);
//     container.appendChild(form);
//     wrapper.appendChild(container);
