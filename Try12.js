...
//             (p) => `
//             <div class="T1_inline-point" style="color: ${darkerTextColor}">
//               ${p.icon ? `<div class="T1_icon-svg" style="display: inline-flex; align-items: center; justify-content: center; color: ${svgColor} !important; fill: ${svgColor} !important;">${svg(p.icon)}</div>` : ''}
//               <span>${p.text}</span>
//             </div>`
//           )
//           .join("")}
...
// // //     const mergedOptions = {
// // //       activeTemplate: (options.activeTemplate || DEFAULT_SETTINGS.activeTemplate).toLowerCase() === "template" ? "Template" : options.activeTemplate || DEFAULT_SETTINGS.activeTemplate,
// // //       isEnabled: options.isEnabled !== undefined ? options.isEnabled : DEFAULT_SETTINGS.isEnabled,
// // //       selectionMode: options.selectionMode || DEFAULT_SETTINGS.selectionMode,
// // //       iconAsset: { ...DEFAULT_SETTINGS.iconAsset, ...options.iconAsset },
// // //       iconStyle: { ...DEFAULT_SETTINGS.iconStyle, ...options.iconStyle },
...
// // //       bulletPoints: options.bulletPoints || [
// // //         { text: contentOptions.bulletPoint1 || "Secure Coverage Customers", icon: "shield" },
// // //         { text: contentOptions.bulletPoint2 || "Instant Claims", icon: "lightning" },
// // //         { text: contentOptions.bulletPoint3 || "Trusted by 50k+", icon: "star" }
// // //       ],
// // //       protectionAddedText: contentOptions.protectionAddedText || "Protection Added",
...
// // //     function renderTemplate() {
// // //       const t = state.activeTemplate;
// // //       if (t === "Template" || t === "Template1") return renderT1();
// // //       if (t === "Template2") return renderT2();
// // //       if (t === "Template3") return renderT3();
// // //       return renderT1(); // fallback to Template1
// // //     }
